...
/**
 * Based on {@link CanvasFrame} developed by Samuel Audet
 *
...
public class CanvasPanel extends JPanel {
    ...
    public static GraphicsDevice getScreenDevice(int screenNumber) throws Exception {
        ...
        if (screenNumber >= screens.length) {
            throw new Exception("CanvasPanel Error: Screen number " + screenNumber + " not found. " +
...
/*
            if (getGraphicsConfiguration() == null) System.out.println("GC is null!");
...
/*
            if (fullScreen) {
                ...
                setResizable(false);
                gd.setFullScreenWindow(CanvasPanel.this);
            } else {
...
*/
    ...
    @Override public void paint(Graphics g) {
        ...
        if (color != null) {
            ...
            System.out.println("fillRect w = " + getWidth() + ", h = " + getHeight());
        }
        if (image != null) {
            g.drawImage(image, 0, 0, getWidth(), getHeight(), null);
            System.out.println("drawImage w = " + getWidth() + ", h = " + getHeight());
        }
        if (buffer != null) {
            g.drawImage(buffer, 0, 0, getWidth(), getHeight(), null);
            System.out.println("drawImage buffer w = " + getWidth() + ", h = " + getHeight());
        }
        g.dispose();
    }
...
*/
    ...
    public void showImage(Image image) {
        if (image == null) {
            ...
            System.out.println("setCanvasSize w = " + w + ", h = " + h);
            setCanvasSize(w, h);
        }
        this.color = null;
        this.image = image;
        if (canvas == null) {
            System.out.println("canvas is null here");
            canvas = getCanvas();
        }
        //paint(null);
        repaint();
    ...
    public static void tile(final CanvasPanel[] frames) {
