package com.corochann.spterminal.example;
...
public class TestDragNDropFiles {
    ...
    public class DropPane extends JPanel {
        ...
        public DropPane() {
            try {
                target = ImageIO.read(new File(ProjectConfig.RES_FOLDER + "play.png"));
            ...
            message = new JLabel();
            message.setFont(message.getFont().deriveFont(Font.BOLD, 20));
            add(message);
        ...
        protected void importFiles(final List files) {
            Runnable run = new Runnable() {
                @Override
                public void run() {
                    String messageStr = "You dropped " + files.size() + " files\n";
