/**
 * The source code is slightly modified from original file obtained at
 * https://github.com/fusesource/jansi/blob/master/jansi/src/main/java/org/fusesource/jansi/AnsiOutputStream.java
 */
...
public class AnsiOutputStream extends FilterOutputStream {
    ...
    private boolean processEscapeCommand(ArrayList<Object> options, int command) throws IOException {
        // System.out.println("[DEBUG] processEscapeCommand, command = " + command);
        try {
            switch (command) {
                case 'A':
                ...
                case 'm':
                    ...
                    for (Object next : options) {
                        if (next != null) {
                            ...
                            //System.out.println("ANSI m option count " + count + ", value " + value);
                            if (value == 7) {
    ...
    private boolean processOperatingSystemCommand(ArrayList<Object> options) throws IOException {
        ...
        // System.out.println("[DEBUG] processOperatingSystemCommand, command = " + command + ", label = " + label);
        try {
            switch (command) {
                case 0:
