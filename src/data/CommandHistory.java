...
import static config.ProjectConfig.CACHE_FOLDER;
...
public class CommandHistory implements Serializable {
    ...
    private static int commandHistoryVecMaxSize = 100000;   // The value must be more than 10 for now, see refresh()
    ...
    /**
     * Constracts & returns a path that this CommandHistory instance is saved.
     * Path is unique for each portName
     * @param portName
     * @return
     */
    private static String getPath(String portName) {
        return CACHE_FOLDER + "/" + PREFIX + "." + portName;
    }
}
